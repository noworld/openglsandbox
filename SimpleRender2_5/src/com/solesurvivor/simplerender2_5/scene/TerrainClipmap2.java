...
public class TerrainClipmap2 implements Node {
	...
	private static final String TAG = TerrainClipmap2.class.getSimpleName();
	...
	public TerrainClipmap2(Geometry clipmap, ClipmapData data) {

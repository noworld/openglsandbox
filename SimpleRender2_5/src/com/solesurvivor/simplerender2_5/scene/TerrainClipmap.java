...
public class TerrainClipmap implements Node {
	...
	protected static final boolean[] CLIP_RENDER = {true, true, true, true, true};
	...
	public TerrainClipmap(Geometry clipmap, ClipmapData data) {
		...
		//0
		int idx = 0;
		mRingBlocks[idx] = new ClipBlock(0, 0, idx * MATRIX_SZ, CLIP_RENDER);
		...
		//1
		idx++;
		mRingBlocks[idx] = new ClipBlock(1, 0, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
		
		//2
		idx++;
		mRingBlocks[idx] = new ClipBlock(2, 0, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);

		//3
		idx++;
		mRingBlocks[idx] = new ClipBlock(3, 0, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0,
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
		
		//4
		idx++;
		mRingBlocks[idx] = new ClipBlock(0, 1, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);

		//5
		idx++;
		mRingBlocks[idx] = new ClipBlock(3, 1, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
		
		//6
		idx++;
		mRingBlocks[idx] = new ClipBlock(0, 2, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
		
		//7
		idx++;
		mRingBlocks[idx] = new ClipBlock(3, 2, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
	
		//8
		idx++;
		mRingBlocks[idx] = new ClipBlock(0, 3, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
	
		//9
		idx++;
		mRingBlocks[idx] = new ClipBlock(1, 3, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
		
		//10
		idx++;
		mRingBlocks[idx] = new ClipBlock(2, 3, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
	
		//11	
		idx++;
		mRingBlocks[idx] = new ClipBlock(3, 3, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mRingBlocks[idx].mXOffset, mRingBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mBlockMat, mRingBlocks[idx].mMatrixOffset, MATRIX_SZ);
		...
		//1
		idx = 0;
		mFillBlocks[idx] = new ClipBlock(1, 1, idx * MATRIX_SZ, CLIP_RENDER);
		...
		//2
		idx++;
		mFillBlocks[idx] = new ClipBlock(2, 1, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mFillBlocks[idx].mXOffset, mFillBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mFillMat, mFillBlocks[idx].mMatrixOffset, MATRIX_SZ);

		//3
		idx++;
		mFillBlocks[idx] = new ClipBlock(1, 2, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mFillBlocks[idx].mXOffset, mFillBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mFillMat, mFillBlocks[idx].mMatrixOffset, MATRIX_SZ);

		//4
		idx++;
		mFillBlocks[idx] = new ClipBlock(2, 2, idx * MATRIX_SZ, CLIP_RENDER);
		System.arraycopy(getBlockMatrix(nHalfSz, mFillBlocks[idx].mXOffset, mFillBlocks[idx].mZOffset, blockDisp, quadWidth), 0, 
				mFillMat, mFillBlocks[idx].mMatrixOffset, MATRIX_SZ);
	...
	private static class ClipBlock {
		...
		public ClipBlock(int mXOffset, int mZOffset, int mMatrixOffset, boolean[] render) {

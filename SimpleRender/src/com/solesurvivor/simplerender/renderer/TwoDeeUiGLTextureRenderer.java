...
public class TwoDeeUiGLTextureRenderer implements GLSurfaceView.Renderer {

	private static final String TAG = TwoDeeUiGLTextureRenderer.class.getSimpleName();
	...
	public TwoDeeUiGLTextureRenderer(Context context) {
	...
	protected void loadModel() {
		...
		TypedArray models = res.obtainTypedArray(R.array.uiModels);

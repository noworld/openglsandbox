...
public class MultiModelGLTextureRenderer implements GLSurfaceView.Renderer {

	private static final String TAG = MultiModelGLTextureRenderer.class.getSimpleName();
	...
	public MultiModelGLTextureRenderer(Context context) {

...
public class SlowSeekBehavior implements NodeState, MessageReceiver {
	
	@SuppressWarnings("unused")
	private static final String TAG = SlowSeekBehavior.class.getSimpleName();
	private static final float MAX_SPEED = 300;
	private static final long TTL = 20*1000;
	private static final double ACCEL = 1.25;

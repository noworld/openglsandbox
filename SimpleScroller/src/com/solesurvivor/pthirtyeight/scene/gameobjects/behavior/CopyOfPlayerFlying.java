...
public class CopyOfPlayerFlying implements NodeState, MessageReceiver {
	
	public static final String NAME = "PlayerFlyingState";
	
	@SuppressWarnings("unused")
	private static final String TAG = CopyOfPlayerFlying.class.getSimpleName();
	...
	public CopyOfPlayerFlying(GameState state) {
		parentState = state;
